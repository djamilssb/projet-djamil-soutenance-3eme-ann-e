...
export default function Home(): React.JSX.Element {
  return (
    <>
      ...
      <section className="flex items-center justify-center flex-row h-[90vh]">
        <Image
          src="/alien1.png"
          alt="Character"
          width={580}
          height={580}
          className="mt-20 animate-pic"
        />
        <div className="w-[43vw] relative animate-pic">
          <Image src="/vaisseau.png" alt="" height={400} width={400} className="absolute right-0 bottom-70 z-25 animate-pic"/>
